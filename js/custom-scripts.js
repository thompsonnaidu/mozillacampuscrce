 ...
 $("#track-image").owlCarousel({
            items : 2, //10 items above 1000px browser width
            itemsDesktop : [1190, 2], //5 items between 1000px and 901px
 ...
 $(function(){
    ...
    $(document).ready(function() {
        ...
        $('.count_down').countdown({
            end_time: "2018/02/17 8:45:00 +5:30",
    ...
    function init_map() {
        ...
        var marker = new google.maps.Marker({
            position: {lat: 19.044497, lng: 72.82045349999999},
            title:"FRCRCE"});
          
        var map = new google.maps.Map(document.getElementById("map"),
            {
            center: {lat: 19.044497, lng: 72.820453},
            zoom: 16,
